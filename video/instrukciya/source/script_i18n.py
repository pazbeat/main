...
def flow(device, lang):
    ...
    if lang == 'en':
        ...
        tap = 'басыңыз' if pc else 'түртіңіз'
        L = {
            'i1': 'Сәлеметсіз бе! Бұл бейнеде imbir.kz сайтында «Имбирь» тай спа-салондар желісінің сыйлық сертификатын қалай сатып алуға болатынын көрсетемін.',
            'i2': 'Бұл бар-жоғы бірнеше минут алады.',
            'h1': 'imbir.kz сайтын ашып, «Сертификат сыйлау» батырмасын басыңыз.' if pc else 'imbir.kz сайтын ашып, жоғарғы оң жақтағы мәзірді түртіп, «Сертификат сыйлау» бөлімін таңдаңыз.',
            'c1': 'Алдымен сатып алу шарттары жазылған терезе ашылады. Оларды мұқият оқып шығыңыз.',
            'c2': f'Содан кейін белгі қойып, «Қабылдаймын» батырмасын {tap}.',
            'd1': 'Бірінші қадам — дизайн.',
            'd2': 'Мерекені таңдаңыз, мысалы, «Туған күн».',
            'd3': 'Бүйірдегі көрсеткілермен ашықхаттарды парақтап, ұнағанын таңдаңыз.' if pc else 'Ашықхаттарды саусақпен сырғытып, ұнағанын таңдаңыз.',
            'd4': f'Содан кейін «Әрі қарай» батырмасын {tap}.',
            'g1': 'Екінші қадам — сыйлық. Бағдарламаны немесе соманы сыйлауға болады.',
            'g2': 'Бағдарламаны сыйлау үшін шеңбердегі атауын басыңыз. Оң жақта сипаттамасы мен бағасы шығады.' if pc else 'Бағдарламаны сыйлау үшін доғаны айналдырып, атауын түртіңіз. Жоғарыда сипаттамасы мен бағасы шығады.',
            'g3': 'Соманы сыйлау үшін «Сомаға» қойындысын ашып, номиналды таңдаңыз — жиырма мыңнан екі жүз мыңға дейін.',
            'g4': f'«Әрі қарай» батырмасын {tap}.',
            'p1': 'Үшінші қадам — арнау жазуы.' if pc else 'Үшінші қадам — алушы.',
            'p2': 'Алушының атын жазыңыз — ол сертификатта басылады.',
            'p3': '«Кімнен» өрісін қаласаңыз ғана толтырасыз.',
            'p4': f'Қаласаңыз, «Құттықтау қосу» батырмасын {tap} де, жүз таңбаға дейін жылы лебіз жазыңыз. Құттықтау да сертификатта болады.',
            ...
            'b2': 'Уайымдамаңыз: сертификатпен желінің кез келген салонында демалуға болады.',
            'b3': f'«Әрі қарай» батырмасын {tap}.',
            'e1': 'Бесінші қадам — жіберу. Сертификатты қашан жіберуді таңдаңыз: төлемнен кейін бірден…',
            'e2': '…немесе таңдалған күні мен уақытта, мысалы, мереке күні таңертең.',
            'e3': 'Email-іңізді жазыңыз. Сертификат пен чек сонда келеді — оны өзіңіз тапсыра аласыз немесе жібере аласыз.',
            'e4': 'Алушының поштасын білсеңіз, екінші өріске жазыңыз — сертификат оған да келеді. Бұл өріс міндетті емес.',
            'e5': f'«Әрі қарай» батырмасын {tap}.',
            'y1': 'Алтыншы қадам — төлем. Тапсырыс деректерін тексеріңіз.',
            'y2': f'Промокодыңыз болса, «Промокод» батырмасын {tap} де, оны енгізіңіз — жеңілдік тапсырыс сомасына қолданылады.',
            'y3': 'Төлем тәсілін таңдаңыз: Kaspi қолданбасы арқылы немесе Visa не Mastercard банк картасымен.',
            'y4': f'Ережелермен келісу белгісін қойып, «Төлеу» батырмасын {tap}.',
            'a1': 'Төлемнен кейін QR-коды бар PDF сертификат көрсетілген поштаға келеді — бірден немесе таңдалған күні.',
            'a2': 'Сертификаттың күйі мен балансын сайттан тексеруге болады.',
            't0': 'Бірнеше маңызды шарт.',
            't1': 'Сертификат сатып алынған күннен бастап үш ай жарамды.',
            't2': 'Ол Imbir Platinum салонынан басқа желінің барлық салондарында қабылданады.',
            't3': 'Салонға алдын ала телефон немесе WhatsApp арқылы жазылыңыз — нөмірлер сайтта бар.',
            't4': 'Бағдарлама басталардан он-он бес минут бұрын келіңіз.',
            't5': 'Салонда сертификатты әкімшіге көрсетіңіз.',
            't6': 'Бағдарлама қымбат болса — айырмасын төлейсіз, арзан болса — қалдығы балансқа сақталады.',
            't7': 'Жазылудан кемінде үш сағат бұрын бас тартыңыз, әйтпесе қызмет есептен шығарылады.',
            't8': 'Сертификат ақшаға айырбасталмайды.',
            'o1': 'Міне, бәрі осы! Таиланд жылуын сыйлаңыз. Сіздерді салондарымызда күтеміз!',
        }
    return L

REPL = {
    'en': [('imbir.kz', 'imbir dot K Z'), ('Imbir', 'Imbeer'), ('“', ''), ('”', ''), ('…', ','), (' — ', ', '), ('—', ','), ('WhatsApp', 'WhatsApp'), ('PDF', 'P D F'), ('QR code', 'Q R code')],
    'kk': [('imbir.kz', 'имбир нүкте кей зет'), ('Imbir Platinum', 'Имбир Платинум'), ('«', ''), ('»', ''), ('…', ','), (' — ', ', '), ('—', ','),
           ('Kaspi', 'Каспи'), ('Visa', 'Виза'), ('Mastercard', 'Мастеркард'), ('PDF', 'пи ди эф'), ('QR-коды', 'кью ар коды'), ('Email-іңізді', 'Имейлыңызды'),
